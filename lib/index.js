...
function watchConfigFile(c) {
    ...
    let cfgPath = coc_nvim.workspace
        .getConfiguration()
...
const cacheSchemaGen = (context) => async (params) => {
    ...
    await fs__default['default'].writeFile(schemaPath(context), new util_1.TextEncoder().encode(JSON.stringify(schemas)), (err) => {
...
async function updateAssociations(params) {
    const config = coc_nvim.workspace.getConfiguration('coc-toml');
