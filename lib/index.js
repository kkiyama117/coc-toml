...
function createClient(p) {
    ...
    const clientOpts = {
        ...
        initializationOptions: {
            configuration: coc_nvim.workspace.getConfiguration().get('coc-toml'),
        },
        synchronize: {
...
var $gOPD$5 = GetIntrinsic$2('%Object.getOwnPropertyDescriptor%');
if ($gOPD$5) {
	try {
		$gOPD$5([], 'length');
	} catch (e) {
...
var throwTypeError$4 = function () { throw new $TypeError$7(); };
...
var INTRINSICS$4 = {
	...
	'%ArrayIteratorPrototype%': hasSymbols$7 ? getProto$5([][Symbol.iterator]()) : undefined$5,
	...
	'%isFinite%': isFinite,
	'%isNaN%': isNaN,
	'%IteratorPrototype%': hasSymbols$7 ? getProto$5(getProto$5([][Symbol.iterator]())) : undefined$5,
	'%JSON%': typeof JSON === 'object' ? JSON : undefined$5,
	'%Map%': typeof Map === 'undefined' ? undefined$5 : Map,
	'%MapIteratorPrototype%': typeof Map === 'undefined' || !hasSymbols$7 ? undefined$5 : getProto$5(new Map()[Symbol.iterator]()),
	'%Math%': Math,
	'%Number%': Number,
	'%Object%': Object,
	'%parseFloat%': parseFloat,
	...
	'%SetIteratorPrototype%': typeof Set === 'undefined' || !hasSymbols$7 ? undefined$5 : getProto$5(new Set()[Symbol.iterator]()),
	'%SharedArrayBuffer%': typeof SharedArrayBuffer === 'undefined' ? undefined$5 : SharedArrayBuffer,
	'%String%': String,
	'%StringIteratorPrototype%': hasSymbols$7 ? getProto$5(''[Symbol.iterator]()) : undefined$5,
	'%Symbol%': hasSymbols$7 ? Symbol : undefined$5,
...
var $gOPD$7 = GetIntrinsic$3('%Object.getOwnPropertyDescriptor%');
if ($gOPD$7) {
	try {
		$gOPD$7([], 'length');
	} catch (e) {
...
var getOwnPropertyDescriptor$1 = $gOPD$7;

var $toString$2 = callBound('Object.prototype.toString');
var hasSymbols$8 = hasSymbols();
var hasToStringTag$6 = hasSymbols$8 && typeof Symbol.toStringTag === 'symbol';
...
var hasToStringTag$7 = hasSymbols$9 && typeof Symbol.toStringTag === 'symbol';
...
class Ctx {
    ...
    async startServer() {
        ...
        this.client.onNotification(UpdateBuiltInSchemas.METHOD, this.updateAssociations);
        this.client.onNotification(CacheSchema.METHOD, this.cacheSchema);
        this.client.onNotification(WatchConfigFile.METHOD, this.watchServerTaploConfigFile);
    ...
    async updateAssociations(params) {
        const config = (this === null || this === void 0 ? void 0 : this.config) ? this.config : exports.globalConfig;
        ...
        if (deepEqual(defaultAssociations, currentAssociations, { strict: true })) {
            ...
            if (config.debug) {
                coc_nvim.workspace.showMessage("associations is same. pass.");
            }
            return;
        }
        if (updateNew !== 'never') {
...
async function activate(context) {
    ...
    const ctx = new Ctx(context, exports.globalConfig);
    // Don't activate if disabled
    if (!exports.globalConfig.enabled) {
    ...
    if (exports.globalConfig.debug) {
        ctx.registerCommand('configList', (ctx) => {
            return async () => {
                coc_nvim.workspace.showMessage(JSON.stringify(ctx.config));
            };
        });
    }
